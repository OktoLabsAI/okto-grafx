...
| 2026-09-03 | P0.2 — instrumentos reproduzíveis | em andamento; primitivas integradas | `tools/perf_round/` integrado em `feature/v0.0.2@c276dec`, com origem imutável `perf/v002-p0-instruments-claude@9635146`: recibo canônico, cópia autenticada, séries independentes, proveniência do código efetivamente executado e terminação fail-closed da árvore de processos. Regressão focada 31/31, Ruff, compileall, diff-check e auditoria adversarial PASS; nenhum benchmark/board vivo acessado. O driver concreto do card/perfil pós-drain ainda precisa ser versionado e usado para fechar P0.2 |
