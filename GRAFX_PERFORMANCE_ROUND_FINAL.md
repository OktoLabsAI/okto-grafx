...
| 2026-09-04 | EDGE / pushdown local abaixo do cartesiano | protótipo recusado e revertido | `b236697` foi invalidado porque alterava ordem/canal de erros, podia ocultar falha persistente do scan interno e converter recusa de budget em escrita confirmada. `030b39d` restaura o plano canônico e adiciona regressões; 15 EDGE + 95 planner verdes. O cliff `N+N²` continua aberto para operador dedicado que preserve `rows_scanned`, budget e atomicidade |
