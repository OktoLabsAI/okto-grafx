...
| GX-CAP-8 | [Arrow and external data](SPEC-GX-CAP-8.md) | Partial: scalar/vector Arrow, Pandas and local Parquet implemented; Polars, external scans and graph exchange remain; [receipt](../reports/V005_AFTER_970AA1E.md) |
| GX-CAP-9 | [Graph projections and algorithms](SPEC-GX-CAP-9.md) | Partial: weighted graph, lookup/CSR, degree/WCC/SCC, BFS/Dijkstra, personalized/NumPy PageRank and linear k-core implemented; catalog/write-back remain; [receipt](../reports/V005_AFTER_970AA1E.md) |
