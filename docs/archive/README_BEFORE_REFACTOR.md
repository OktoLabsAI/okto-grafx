> Historical README, frozen before the 2026-09-08 refactor.
> Do not use these examples, guarantees or performance gates as the current contract.
...
change. Read [Status and limitations](../../README.md#status-and-limitations) before you rely on it.
...
- [Ports and adapters](../../README.md#ports-and-adapters)
...
- **Write throughput is currently platform-bound and serialized** — ~300 ms per durable commit on
  ...
  conditions, and the instruments to re-run them are in [`docs/PERFORMANCE.md`](../reports/PERFORMANCE_HISTORY.md).
...
|---|---|
| [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md) | The detailed architecture: components, protocols, data flow, on-disk formats |
| [`docs/PERFORMANCE.md`](../reports/PERFORMANCE_HISTORY.md) | Measured numbers with their conditions and the in-tree instruments that reproduce them — reads under load, traversal, scaling, and the D5 cross-platform record |
| [`docs/PORTS.md`](../PORTS.md) | Every port, its protocol, its default adapter, and how to write your own |
...
| [`docs/architecture/ST2_DESCRIPTOR_REVALIDATION.md`](../architecture/ST2_DESCRIPTOR_REVALIDATION.md) | The strict/default and generation/opt-in descriptor identity policies, exact whitelist, risks and deployment guidance |
| [`docs/architecture/P2_IDENTITY_SECONDARY_INDEXES_V1.md`](../architecture/P2_IDENTITY_SECONDARY_INDEXES_V1.md) | Catalog-v2 identity/custom exact indexes, immutable generations, sizing, foreground rehash, compatibility and recovery contract |
