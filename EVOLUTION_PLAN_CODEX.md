...
- **Compatibilidade Okto Pulse: M-PULSE-1 a M-PULSE-6 concluídos e certificados conforme o quadro
  ...
  medições limpas após a estabilização. A frente A1 foi congelada e publicada em
  ...
  congelado no commit `aa3de79f`; o plano/harness conjunto continua em revisão no handoff
