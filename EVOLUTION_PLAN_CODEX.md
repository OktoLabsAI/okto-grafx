...
- **Linha `0.0.2` iniciada sob o plano de performance congelado.** A branch canônica de trabalho é
  ...
  ocultar duplicata corrupta. P0.2 está em andamento com instrumentos mínimos e fail-closed. P0.3
  e P0.4 somente começam depois que o backfill vivo terminar, sempre sobre cópia autenticada. A
