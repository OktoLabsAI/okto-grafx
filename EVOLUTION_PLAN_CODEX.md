...
| M-PULSE-2J — upper bound implícito | entregue para verificação, não concluído | baseline `main@4dc2b6564bc90d83d312345c77fdfa5d61a020a1` | Somente `*`, `*..` e `*n..` recebem upper 20, como o contrato Pulse; máximo explícito 30 permanece. AST/análise fornecida não pode contornar tipos/ordem/teto. Ratchet esperado: raw 73/14, seis débitos, somente `unbounded variable length` muda; 97 entries seguem 82/13. Demais seis gaps e toda superfície pública/persistida ficam invariantes |
