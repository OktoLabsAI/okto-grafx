...
- **Compatibilidade Okto Pulse: M-PULSE-1 a M-PULSE-6 concluídos e certificados conforme o quadro
  ...
  `5.606,6 ms` instrumentados a 94 reconstruções da view pública de catálogo; por isso a frente
  C-community já congelada foi iniciada no handoff `hof_d301014276c148c59c4709a2c2a87950`, sem
  alterar o checkout candidato. O plano/harness conjunto foi certificado no handoff
...
cross-process já prevista. Ela não será antecipada antes de medir C-community.
...
| M-PULSE-7 — estabilização de performance A1/B/C | em execução; A1+B certificadas, integradas e publicadas em `main`; candidato e referência Ladybug concluíram `per_family=5`, mas o alvo de performance existente não passou; C-community em implementação no worktree delegado | base Grafx `6d9b7a1`; A1 `5002a77c8d4e59e137890a45bcf61874398d2dcc`; B original `420ca4886e5e226aa10bf3a28a1396f98471faca`; código integrado `91a59c6806659cdd75d1b33500885f0c7354de6b`; candidato medido `origin/main@fb1c7c9a7e81699246674ce037c1b64c7d12b03f`; handoffs B `hof_7a5be05b5b644b609b92b5e8c09fdeea`, harness `hof_1ad44f9d92d04f58abbcfe4a6e316ba6`, fixture `hof_42a66b0033f0454ca5e12b3f27668141`, runbook `hof_93dbf437246040a3a83cb900f3a488ea` concluídos/PASS; C-community `hof_d301014276c148c59c4709a2c2a87950` em execução | A1 remove o fan-out de page 0 entre tabelas com freshness fail-closed; B restringe o namespace, elimina `realpath` do hit quente e preserva a contenção contra redirects. Gates A1 e B e validação pós-integração permanecem verdes. Evidência curta causal: baseline `6d9b7a1`/reopen (`4f828baf0ef5755c7a065a52efb48bbed28c93a941ac815107eddd3131eb2837`) `97.623,1 ms`; B/reopen (`fc8af4c8329578957375b3879d402937c2a44e0154a95eec5433c7a26c00acf9`) `38.732,6 ms` (`2,52x`). A1/continuous (`a749c2eefe89e77f6b8c69a1d0bcaa6d9a5b8f629bac9e295ae1c71c99a18279`) `68.477,9 ms`; A1+B/continuous (`0c5ee72fc42c6cb1ad74b18387bc74e6e274c897d01de582f281786d5f7bde27`) `19.266,1 ms` (`3,55x`), 12/12, mesmo digest/forense/WAL e 43 páginas de índice. Rodada `per_family=5`: Grafx (`83b4561e50a2a7a8b4e6126599c55ce392877a8684c1f59b5ae47ce4260fc1ae`, 525.534 B) `18.561,15 ms`; Ladybug (`5d469ad5987ebe3e0201c1e537a668feec79d83897debaf9072ad1716ddb9bf6`, 394.715 B) `970,62 ms`; ambos 12/12, `operation_set_sha256=c994255b0bf695040c972ce339cc5d580ec253d2146674664e7722cf6b5a7f81`, mesma forense/pós-condições. Razão `19,12x`: não atende D5 `<=10x` nem a meta final `<=1x`; o manifesto M-PULSE-7 não contém SLO, mas o plano de performance continua aberto. Atribuição: catálogo público 94 chamadas/`5.606,6 ms`, `_still_names` `7.713,3 ms`, parse `402,6 ms`, flush `83,5 ms`; logo C-community entra agora, A2/plan cache não são promovidos sem ganho material. Quarentenas e RUN #4 permanecem inalterados |
