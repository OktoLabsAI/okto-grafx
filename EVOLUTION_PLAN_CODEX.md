...
- **Compatibilidade Okto Pulse: M-PULSE-1 a M-PULSE-6 concluídos e certificados conforme o quadro
  ...
  anterior está congelado no commit `aa3de79f`. O plano/harness conjunto foi certificado no handoff
...
| M-PULSE-7 — estabilização de performance A1/B | em execução; A1+B certificadas, integradas serialmente e publicadas em `main`; medição curta limpa combinada concluída; somente a rodada oficial `per_family=5` permanece pendente nesta frente | base Grafx `6d9b7a1`; A1 `5002a77c8d4e59e137890a45bcf61874398d2dcc`; B original `420ca4886e5e226aa10bf3a28a1396f98471faca`; integração `origin/main@91a59c6806659cdd75d1b33500885f0c7354de6b`; handoff B `hof_7a5be05b5b644b609b92b5e8c09fdeea`, harness `hof_1ad44f9d92d04f58abbcfe4a6e316ba6`, correção de fixture `hof_42a66b0033f0454ca5e12b3f27668141` e runbook `hof_93dbf437246040a3a83cb900f3a488ea` concluídos/verificados/PASS | A1 remove o fan-out de page 0 entre tabelas, deriva high-water somente de headers do heap e mantém fail-closed local/reopen/cross-process para índice omitido. Gates A1: regressão ampla 1.707/1.707, índices 202/202, query/public concurrency 311/311, nullable/vector visibility 29/29 e txn index-wiring/commit-protocol 65/65. B restringe `list_files(prefix)` ao namespace pertinente, elimina `realpath` do hit quente, mantém `stat/fstat` e fixa cada diretório antes/depois do `scandir`; o gate final passou 1.185 testes/12 skips atribuídos, junction NTFS real recusada, com repetição Codex exit 0 e validação pós-integração verde. Evidência curta causal: baseline `6d9b7a1`/`reopen` (`4f828baf0ef5755c7a065a52efb48bbed28c93a941ac815107eddd3131eb2837`) = `97.623,1 ms` RAW; B/reopen (`fc8af4c8329578957375b3879d402937c2a44e0154a95eec5433c7a26c00acf9`) = `38.732,6 ms` (`2,52x`), 12/12, mesmo digest/forense/WAL. Evidência combinada decisiva curta: A1/continuous (`a749c2eefe89e77f6b8c69a1d0bcaa6d9a5b8f629bac9e295ae1c71c99a18279`) = `68.477,9 ms`; A1+B/continuous (`0c5ee72fc42c6cb1ad74b18387bc74e6e274c897d01de582f281786d5f7bde27`, 136.432 B) = `19.266,1 ms` (`3,55x`), 12/12, `operation_set_sha256=61e21ccfaa46d8e1012424646960acac66f917e7df80df1d520c5c7ac1dffe9f`, forense `6dd6cf05316b38b01bade965b5fc5e4b118b1853f28c7aef705a8d283e0f0f0c`, WAL idêntico e 43 páginas de índice em ambos; `list_files` instrumentado caiu `21.798,5 -> 195,3 ms` (`111,62x`). O smoke antigo `e13a6899…` e a sonda `e722a3d…` seguem QUARANTINED; RUN #4 não tem verdict. A rodada `per_family=5` permanece o gate oficial já congelado, sem novo requisito |
