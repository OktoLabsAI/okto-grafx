...
- **Linha `0.0.2` iniciada sob o plano de performance congelado.** A branch canônica de trabalho é
  ...
  estão publicados, e o marco integrado mais recente é `69368c3`. A auditoria do Pulse Community pinado em `d50c034`
