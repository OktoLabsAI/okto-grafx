...
- **Linha `0.0.2` iniciada sob o plano de performance congelado.** A branch canônica de trabalho é
  ...
  estão publicados até `8aced0b`. A auditoria do Pulse pinado em `d50c034` confirmou que o backfill
  ...
  ocultar duplicata corrupta. P0.2 integrou em `c276dec` as primitivas fail-closed de recibo, cópia
  autenticada e séries independentes (31 testes focados e auditoria adversarial PASS), mas permanece
  em andamento até versionar e usar o driver concreto pós-drain. P0.3 e P0.4 somente começam depois
  que o backfill vivo terminar, sempre sobre cópia autenticada. A
