...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("20240102", 1_704_153_600_000_000),
        ("2024W01", 1_704_067_200_000_000),
        ("2024W011", 1_704_067_200_000_000),
        ("2024W01T03", 1_704_078_000_000_000),
        ("2024W37023", 1_725_922_800_000_000),
        ("2024-W01", 1_704_067_200_000_000),
        ("2024-W01-1", 1_704_067_200_000_000),
        ("2024-W01-1T03", 1_704_078_000_000_000),
        ("2024-01-02T03", 1_704_164_400_000_000),
        ("2024-01-02T0304", 1_704_164_640_000_000),
        ("2024-01-02T03:04", 1_704_164_640_000_000),
        ("2024-01-02T030405", 1_704_164_645_000_000),
        ("2024-01-02T03.5", 1_704_164_400_500_000),
        ("2024-01-02T03:04,12", 1_704_164_640_120_000),
        ("2024-01-02T03:04:05.1234569", 1_704_164_645_123_456),
        ("2024-01-02T03:04:05+023045", 1_704_155_600_000_000),
        ("2024-01-02T03:04:05+01:60", 1_704_157_445_000_000),
        ("2024-01-02T03:04:05+00:00:60", 1_704_164_585_000_000),
        ("2024-01-02T03:04:05+00:00:00.5", 1_704_164_645_000_000),
        ("2024-01-02T03:04:05+00:00:01.5", 1_704_164_643_500_000),
        ("2024-01-02T03:04:05.Z", 1_704_164_645_000_000),
        ("2024-01-02T03:04:05.+02", 1_704_157_445_000_000),
        ("2024-01-02T03-04", 1_704_178_800_000_000),
        ("0001-01-01T00:00:00+23:59:59.999999", -62_135_683_199_999_999),
        (
            "9999-12-31T23:59:59.999999-23:59:59.999999",
            253_402_387_199_999_998,
        ),
    ),
)
def test_timestamp_preserves_the_frozen_pure_parser_surface(
    stack: QueryStack, written: str, micros: int
) -> None:
    """Calendar, week, fraction and offset rules stay literal at the pure boundary."""
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "2024-01-02T0304:05",
        "2024-01-02T03:04:05.",
        "2024-01-02T03:04:05+24",
        "2024-01-02T03:04:05+23:60",
        "2024-01-02T03:04:05Z+01",
        "2024-01-02T03:04:05junk",
    ),
)
def test_timestamp_refuses_every_form_outside_the_frozen_surface(
    stack: QueryStack, written: str
) -> None:
    """Invalid syntax closes as one stable planning error, never a parser exception."""

    with pytest.raises(GrafxPlanError) as failure:
        run(stack, "MATCH (p:Person) RETURN timestamp($t)", {"t": written})
