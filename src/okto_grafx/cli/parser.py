...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    _database_command(
        ...
        details=(
            ...
            "transaction that rolls back are discarded. Schema changes share that transaction:",
            "later statements see its staged schema; rollback abandons it. A failure after a",
            "durable COMMIT must be reconciled, not treated as permission to repeat the write.",
